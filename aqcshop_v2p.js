 ...
 *  AQ03009 百度网盘会员月卡
 *  AQ03010 百度网盘超级会员月卡
 *  多商品请用逗号分割 格式:AQ03006,AQ03007,AQ03008
 */
const $ = new Env('爱妻查商城监控');
const aqcookie = $.getdata('aqcCookies');
aqcGoods=$.getdata('aqcGood');
aqcookieArr = [];
aqcookieGoodsArr = [];
...
const myRequest = {
    url: `https://qiye.baidu.com/usercenter/getBenefitStatusAjax`,
    method: "GET",
    headers: headers
};
...
!(async () => {
    if (aqcookie) {
        ...
        $feed.push('elecV2P 通知-爱企查', '请手动抓取cookies')
        return;
    }
